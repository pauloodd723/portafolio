    ...
    <main className="min-h-screen bg-tea-300 dark:bg-pale-600 font-changa text-black dark:text-white font-[family-name:var(--font-Changa-Bold)]">
      ...
      <header className="bg-pale-400 dark:bg-pale-800 p-4">
        <div className="container mx-auto flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap space-x-6 w-full sm:w-8 mt-4 sm:mt-0">
            ...
            {/* switch */}
      <section className="absolute top-8 left-10 hover:underline transform hover:translate-y-1 transition-all ">
        <ThemeSwitch />
      </section>
